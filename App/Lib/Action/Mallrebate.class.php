...
class Mallrebate extends Common {
    ...
    public function __construct() {
        ...
        $this->mall_rebate_order_setting_model = M('mall_rebate_order_setting');
        $this->mall_rebate_other_model = M('mall_rebate_other');
        $this->mall_money_log_model = M('mall_money_log');
        $this->mall_money_funds_model=M('mall_money_funds');
