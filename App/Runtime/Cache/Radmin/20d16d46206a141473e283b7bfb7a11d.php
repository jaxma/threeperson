            ...
            <ul class="sidebar-menu">
                ...
                <!-- <li class="treeview">
                   ...
                   <!--  </a>
                    <ul class="treeview-menu"> -->
<!--                         <li>
                            <a class="tm-items" data-menu-node='m-2-1' data-open="__GROUP__/company/edit?id=2">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">公司信息</span>
                            </a>
                        </li> -->
                        <!-- <li>
                            <a class="tm-items" data-menu-node='m-2-2' data-open="__GROUP__/company/introduct_edit?id=3">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">首页介绍</span>
                            </a>
                        </li>
                        <li>
                            <a class="tm-items" data-menu-node='m-2-2' data-open="__GROUP__/company/photo?type=1">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">首页图片</span>
                            </a>
                        </li>
                        <li>
                            <a class="tm-items" data-menu-node='m-2-2' data-open="__GROUP__/company/photo?type=2">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">经典图片</span>
                            </a>
                        </li> -->
                        <!-- <li>
                ...
                <?php endif;?>
                <?php if( in_array($aid,$superids) || in_array(3,$admin_auth)):?>
                <li class="treeview">
                    <a href="javascript:;" class="list">
                ...
                <?php if( in_array($aid,$superids) || in_array(4,$admin_auth)|| in_array(5,$admin_auth)):?>
                <li class="treeview">
                    <a href="javascript:;" class="list">
                    ...
                    <ul class="treeview-menu">
                        <?php if( in_array($aid,$superids) || in_array(4,$admin_auth)):?>
                        <li>
                            <a class="tm-items" data-menu-node='m-4-1' data-open="__GROUP__/item/picindex">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">封面图列表</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <?php endif;?>
                        <?php if( in_array($aid,$superids) || in_array(5,$admin_auth)):?>
                        <li>
                            <a class="tm-items" data-menu-node='m-4-1' data-open="__GROUP__/news/index">
                                <i class="fa fa-plus-circle icons2"></i>
                ...
                <?php if( in_array($aid,$superids) || in_array(6,$admin_auth)):?>
                <li class="treeview">
                    <a href="javascript:;" class="list">
                        <i class="fa fa-bank icons"></i>
                        <span class="title">关于TOPOS</span>
                        <span class="fa fa-angle-right arrow-icon"></span>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                            <a class="tm-items" data-menu-node='m-5-1' data-open="__GROUP__/aboutus/article?id=1">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">头部介绍</span>
                            </a>
                            <a class="tm-items" data-menu-node='m-5-2' data-open="__GROUP__/aboutus/article?id=2">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">FirstArticle</span>
                            </a>
                            <a class="tm-items" data-menu-node='m-5-3' data-open="__GROUP__/aboutus/article?id=3">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">SecondArticle</span>
                            </a>
                            <a class="tm-items" data-menu-node='m-5-4' data-open="__GROUP__/aboutus/article?id=4">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">ThirdArticle</span>
                            </a>
                            <a class="tm-items" data-menu-node='m-5-5' data-open="__GROUP__/aboutus/article?id=5">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">FourthArticle</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <?php if( in_array($aid,$superids) || in_array(2,$admin_auth) || in_array(7,$admin_auth)):?>
                <li class="treeview">
                    <a href="javascript:;" class="list">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li style="display: none;">
                            <a class="tm-items" data-menu-node='m-22-4' data-open="__GROUP__/company/wechat">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">微信公众号和Ins</span>
                            </a>
                        </li>
                        <li>
                            <a class="tm-items" data-menu-node='m-22-5' data-open="__GROUP__/company/icon">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">分享管理</span>
                            </a>
                        </li>
                        <li>
                            <a class="tm-items" data-menu-node='m-22-6' data-open="__GROUP__/company/foot_icon">
                                <i class="fa fa-plus-circle icons2"></i>
                                <span class="title2">底部分享</span>
                            </a>
                        </li>
                        <li>
...
<!--                         <li>
                            <a class="tm-items" data-menu-node='m-22-5' data-open="__GROUP__/webset/certificate_set">
                                <i class="fa fa-plus-circle icons2"></i>
