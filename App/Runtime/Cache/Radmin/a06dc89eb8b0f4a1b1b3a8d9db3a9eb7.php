...
<div class="container-fluid edit-wrapper">
	<header class="edit-title">
		<blockquote class="layui-elem-quote">
			<span class="title">编辑摄影封面信息</span>
		</blockquote>
	</header>
	<div class="layui-content">
		<form class="layui-form layui-box" action="__URL__/update" data-auto="false" method="post">
			...
			<div class="layui-form-item  items">
				<label class="form-text">摄影分类：</label>
				<div class="form-right">
			...
			<!--引入图片页面-->
			<div class="layui-form-item items">
				<label class="form-text label-required">摄影封面图片：</label>
				<div class="form-right">
  ...
  <div class="layui-upload layui-inline">
    ...
    <input type="hidden" class="image-name" name="image" value="<?php echo ($row["image"]); ?>" />
			...
			<div class="layui-form-item  items">
				...
				<div class="form-right">
					<input class="input-inf2" type="text" name="presents" lay-verify="" autocomplete="off" placeholder="请输入简短介绍" value="<?php echo ($row["presents"]); ?>">
				</div>
			</div>
			<div class="layui-form-item  items">
...
<!-- 			<div class="layui-form-item  items">
				<label class="form-text">详情（其他）：</label>
				<div class="form-right">
					<textarea id="editor" class="ueditors" name="disc"><?php echo ($row["news"]); ?></textarea>
					<!DOCTYPE html>
<html>
