...
<!--         <div class="about_web">
        ...
        <div class="admin_message">
            <fieldset>
                ...
                <span class="color"><?php echo ($info["user_name"]); ?>，您好！</span> 最后一次登录IP地址：<?php echo ($info["last_ip"]); ?>　 时间：<?php echo (date('Y-m-d H:i:s',$info["last_login"])); ?> 
            </fieldset>
        </div>
        <div class="minlineheight"></div>
        <div class="table_Box">
            <table cellspacing="0" border="0" cellpadding="0" width="100%">
                ...
                <tr>
                    <td>目前版本：V3.1.0</td>
                    <td>程序开发：<a href="http://www.cyx.com" target="_blank">广州cyx科技</a></td>
                    <td>联系方式：http://www.cyx.com</td>
                    <td></td>
                </tr>
                <tr>
                    <td>版权声明：</td>
