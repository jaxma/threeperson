...
define(['jquery', 'admin.plugs'], function () {
    ...
    //监听form表单提交和ajax处理表单 add by zbs
//    this.$body.on('click', 'button[data-submit]', function () {
//        var $form = $('#'+form_id), $body = $('body');
//        $form.validate();
//        var formData = new FormData(document.getElementById(form_id));//表单id
//        // $form.submit();
//        // $.form.load("", formData, "post");
//        $.ajax({
//          url: request_url ,
//          type: 'POST',
//          data: formData,
